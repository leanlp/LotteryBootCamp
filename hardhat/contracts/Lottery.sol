...
import {LotteryToken} from "../contracts/Token.sol";

contract Lottery is Ownable {
//    Address of the token used as payment for the bets
    LotteryToken public paymentToken;
    // Amount of tokens given per ETH paid
    uint256 public purchaseRatio;
    //Amount of tokens required for placing a bet that goes for the prize pool
    uint256 public betPrice;
    // Amount of tokens required for placing a bet that goes for the owner pool
    uint256 public betFee;
    // Amount of tokens in the prize pool
    uint256 public prizePool;
    // Amount of tokens in the owner pool
    uint256 public ownerPool;
    // Flag indicating if the lottery is open for bets
    bool public betsOpen;
    // Timestamp of the lottery next closing date
    uint256 public betsClosingTime;
    // Mapping of prize available for withdraw for each account
